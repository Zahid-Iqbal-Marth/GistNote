...
import logo from "../../media/emumba-logo.png"
...
const Navbar : (props: object) => JSX.Element = (props: object) => {
    ...
    const {
        ...
        dp : loggedInUserDP
    } : OwnerType = useSelector(getAuthData);
    ...
    const handleSearchByChange : (event: ChangeEvent<HTMLInputElement>) => void = useCallback((event: ChangeEvent<HTMLInputElement>) => setSearch({
        type : searchType,
    ...
    const dpButton : JSX.Element = (
            <button className="navbar-dp-btn"
                    type="button"
    ...
    const dpMenu : JSX.Element =  (
        ...
        <section className="navbar-profile-menu">
            <section className="navbar-profile-menu-content" 
                onMouseLeave={handleProfileMenu}
                >
                <p>
                    Signed In as {loggedInUserName}
                </p>
                <hr />
                ...
                <button type="button" onClick={handleProfileMenu}>
                    <a  
                        href={`https://github.com/${loggedInUserName}`}
                        target="_blank">
                        View GitHub Profile
                    </a>
                </button>
            ...
            <section className="navbar-nav-bar" id = "navbar">
                ...
                <section className="navbar-left">
                    <section className="navbar-search-section" id ="search-bar">
                        <input  className="navbar-search-bar" 
                                type="text" 
                    ...
                    <section>
                        {loggedInUserName ?  dpButton : loginButton}
                    </section>
                </section>
            </section>
        </nav>
